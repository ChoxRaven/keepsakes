...
public interface ModItems {
    ...
    Item HUNTERS_REGARDS = create("hunters_regards", new HuntersRegardsItem(ToolMaterials.IRON, new Item.Settings())); // What HP?
    ...
    Item ENCHANTED_WHETSTONE = create("enchanted_whetstone", new EnchantedWhetstoneItem(new Item.Settings())); // Glorified Sharpener
